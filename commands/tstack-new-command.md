...
description: Scaffold a new tstack command with proper frontmatter. Places in the right directory (global or project).
...
Create `tstack-<name>.md`:

```markdown
---
name: tstack-<name>
description: <one-line description shown in /tstack-help>
