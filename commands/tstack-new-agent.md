...
description: Scaffold a new tstack agent with proper frontmatter. Places in the right directory (global or project).
...
Create `tstack-<name>.md` with this structure:
