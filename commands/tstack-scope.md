...
Invoke the `tstack-research` skill (if available) or use web search directly to research the topic. Document findings in the scope output.
...
This output is consumed by `/tstack-plan` — keep it concrete and complete.
